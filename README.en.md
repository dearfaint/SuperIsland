...
<p align="center">
  <strong>English</strong> · <a href="README.md">简体中文说明</a>
</p>
...
- Local third-party extension installation with permission review, immediate activation, and clean uninstall of extension files and saved data.
- An installable **Nudge** extension with custom minute delays and selectable alert sounds, included as a third-party package rather than a built-in module.
...
InstallableExtensions/
                    Third-party folders intended for manual installation
...
For a ready-to-install example, choose the [Nudge](InstallableExtensions/Nudge) folder in **Settings -> Extensions -> Install Extension**.
...
<a href="https://www.star-history.com/#dearfaint/SuperIsland&Date">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/svg?repos=dearfaint/SuperIsland&type=Date&theme=dark" />
    <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/svg?repos=dearfaint/SuperIsland&type=Date" />
    <img alt="Star History Chart" src="https://api.star-history.com/svg?repos=dearfaint/SuperIsland&type=Date" />
  </picture>
</a>
